  ...
  if (
    ...
    var t = document.getElementById('chatbot-script-iframe'),
      ...
      o = function () {
        ...
        e.open(),
          e.write(
            '<!DOCTYPE html><script async type="module" src="https://cdn.jsdelivr.net/gh/ImChang-gyu/sdk-deploy-test/index-13925c07.js" charset="UTF-8"></script><link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ImChang-gyu/sdk-deploy-test/index-3715e62e.css">'
          ),
          e.write(
