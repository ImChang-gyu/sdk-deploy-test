  ...
  if (
    ...
    var t = document.getElementById("ntbot-script-iframe"),
      ...
      o = function () {
        ...
        e.open(),
          e.write(
            '<!DOCTYPE html><script async type="module" src="https://cdn.jsdelivr.net/gh/ImChang-gyu/sdk-deploy-test/index-9e156896.js" charset="UTF-8"> <link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/ImChang-gyu/sdk-deploy-test/index-4996847a.css"></script>'
          ),
          e.write(
