!(function () {
  ...
  if (
    ...
    i.innerHTML +=
      '<style>.hidden{ visibility: hidden; }</style><div class="ntbot-entry"></div><div id="ntbot-plugin-script" class="hidden" style="position:fixed!important;right:24px!important;bottom:110px!important;width:420px!important;height:750px!important;@media(max-width:444:px){width:100%!important;height:calc(100% - 110px)!important;right:0px!important}" ><iframe id="ntbot-script-iframe" title="Ntbot" style="position:relative!important;height:100%!important;width:100%!important;border:none!important;"></iframe></div>';
    var t = document.getElementById("ntbot-script-iframe"),
      ...
      o = function () {
        ...
        e.open(),
          e.write(
            '<!DOCTYPE html><script async type="module" src="https://cdn.jsdelivr.net/gh/ImChang-gyu/sdk-deploy-test/index-630729a8.js" charset="UTF-8"></script>'
          ),
          e.write(
